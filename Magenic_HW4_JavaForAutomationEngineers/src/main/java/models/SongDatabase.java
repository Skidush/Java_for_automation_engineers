...
public class SongDatabase {
    ...
    public void createPlaylist(String playlistName) throws IllegalArgumentException {
        ...
        if (playlists.containsKey(playlistName)) {
            ...
            throw new IllegalArgumentException("The playlist with the name " + playlistName + " already exists!");
        }
    ...
    public List<Song> getPlaylist(String playlistName) {
        ...
        if (this.getPlaylists().containsKey(playlistName)) {
            return this.getPlaylists().get(playlistName);
        }
    ...
    public void addSongToPlaylist(Song newSong, String playlistName) {
        ...
        if (!this.playlists.containsKey(playlistName)) {
            this.playlists.put(playlistName, new ArrayList<>());
        }

        this.playlists.get(playlistName).add(newSong);
    }
